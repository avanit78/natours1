      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'POST',
            // url: 'http://127.0.0.1:3000/api/v1/users/login',
            url: "/api/v1/reviews/".concat(tourId),
            data: {
              rating: rating,
              review: review
            }
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"addTour.js":[function(require,module,exports) {
"use strict";
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var addTour = exports.addTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, slug, duration, maxGroupSize, difficulty, price, summary, description, imageCover, images, startDates, startLocation, locations, guides) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Tour Added');
            window.setTimeout(function () {
              location.assign('/');
            }, 1000);
          }
  ...
  return function addTour(_x, _x2, _x3, _x4, _x5, _x6, _x7, _x8, _x9, _x10, _x11, _x12, _x13, _x14) {
    return _ref.apply(this, arguments);
  };
}();
...
var stripe = Stripe('pk_test_51PiqYJSEYzaZJ0DAuOQ3TFOej1rvsrIBESxQnqr3J096XkplYIM85UEExoIwv5x25GfRkPFNW62I0jwPvUDpl2IA00xoAW4psX');
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 8:
          _context.prev = 8;
          _context.t0 = _context["catch"](0);
          console.error('Error booking tour:', _context.t0);
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(startDate, endDate) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          a = res.data.data.bookings;
          b = res.data.data.tours;
          c = res.data.data.users; // Redirect to viewreports and pass data as query params or in the body
          if (res.data.status === 'success') {
            window.setTimeout(function () {
              ...
              location.assign("/viewreports?".concat(queryParams));
            }, 1000);
          }
          _context.next = 13;
          break;
...
if (ReportDate) ReportDate.addEventListener('submit', function (e) {
  e.preventDefault();
  var startDate = document.getElementById('startDate').value;
  var endDate = document.getElementById('endDate').value;
  (0, _report.report)(startDate, endDate);
});
...
if (tourForm) tourForm.addEventListener('submit', function (e) {
  ...
  var startDates = JSON.parse(document.getElementById('startDates').value);
  var startLocation = JSON.parse(document.getElementById('startLocation').value);
  var locations = JSON.parse(document.getElementById('locations').value);
  var guides = JSON.parse(document.getElementById('guides').value);
  (0, _addTour.addTour)(name, slug, duration, maxGroupSize, difficulty, price, summary, description, imageCover, images, startDates, startLocation, locations, guides);
});
if (reviewIdValue) {
...
if (updatePassForm) updatePassForm.addEventListener('submit', /*#__PURE__*/function () {
