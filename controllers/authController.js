...
exports.login = catchAsync(async(req,res,next)=>{
    ...
    if(!email || !password){
        return next(new AppError('Please provide email and passwprd!',400));
    }
    ...
    if(!user || !await user.correctPassword(password, user.password)){
        return next(new AppError('Incorrect email or passwprd!',401));
    }
...
exports.restrictTo = (...roles)=>{
    return (req,res,next)=>{
        //roles ['admin','lead-gauide']. role='user'
...
exports.forgotPassword = catchAsync(async(req,res,next) => {
    ...
    // const message = `Forgot your password? Submit a patch requst with your new password ans passwordConfirm to: ${resetURL}.\nIf you didn't forgot your password, please ignore this email`;
